...
commands = {'Update', 'New', 'NewOK', 'Close','SetMethod', 'Method', ...
  ...
  % display order stuff
		...
		case 'SetMethod',
			...
			if val<3,
				...
				if go,
				 try,
				     script=setDisplayMethod(script,val-1,reps);
				...
				if go,
				  try,
				    script=setDisplayMethod(script,val-1,do);
				    assignin('base',scriptstruct.scriptname,...
			             script);
				    ScriptObjEditor Update;
...
dispord_ctl = uicontrol('Parent',h0, ...
        ...
        'ListboxTop',0, ...
	'Fontsize',9,'Max',2,...
        'Position',[278.56+dmx 32.659+dmy 321.79 49.94], ...
        'Style','text', ...
        'Tag','EditText1');
dispparam_ctl = uicontrol('Parent',h0, ...
        ...
        'HorizontalAlignment','left', ...
        'ListboxTop',0, ...
        'Position',[280.4859+dmx 84.53+dmy 144.08 18.250], ...

...
%
%  Breaks apart a script and an MTI into separate parts. ELEMS1 should be a 
%  list of stim numbers that should go in SCRIPT1 and MTI1. All other stims 
%  will go into SCRIPT2 and MTI2.

...
%  phaseSequence   -   Optional -- if provided, the stimulus will be broken down into phaseSteps number
%                  -     of steps and shown in the order of phaseSequence (default [])
%  phaseSteps      -   Optional -- The number of discrete phases in which to divide the stimulus (default [])
%
%
...
if nargin==0, 
	...
	default_p.dispprefs = {};
	default_p.phaseSteps = [];
	default_p.phaseSequence = [];
...
%	durtn_str = mat2str(round(PSparams.nCycles./PSparams.tFrequency));
	...
	if isfield(PSparams,'phaseSequence'),
		phaseSequence_str = mat2str(PSparams.phaseSequence);
	else,
		phaseSequence_str = '';
	end;
	if isfield(PSparams,'phaseSteps'),
		phaseSteps_str = int2str(PSparams.phaseSteps);
	else,
		phaseSteps_str = '';
	end;
...
h1 = uicontrol('Parent',h0, ...
             ...
             'HorizontalAlignment','left', ...
             'ListboxTop',0, ...
             'Position',[25 39+120 250 19.2], ...
             'String','Optional phaseSequence: (default [])',...
             'Style','text', ...
             'Tag','StaticText2');
phaseSequence_ctl = uicontrol('Parent',h0, ...
             'Units','pixels', ...
             'BackgroundColor',[1 1 1], ...
                       'FontSize', 9, ...
             'HorizontalAlignment','left', ...
             'ListboxTop',0, ...
             'Position',[25 39+100 343 19], ...
             'String',phaseSequence_str, ...
             'Style','edit', ...
             'Tag','EditText1');
h1 = uicontrol('Parent',h0, ...
             'Units','pixels', ...
             ...
             'HorizontalAlignment','left', ...
             'ListboxTop',0, ...
             'Position',[25 39+80 250 19.2], ...
             'String','Optional phaseSteps: (default [])',...
             'Style','text', ...
             'Tag','StaticText2');
phaseSteps_ctl = uicontrol('Parent',h0, ...
             'Units','pixels', ...
             'BackgroundColor',[1 1 1], ...
                       'FontSize', 9, ...
             'HorizontalAlignment','left', ...
             'ListboxTop',0, ...
             'Position',[25 39+60 343 19], ...
             'String',phaseSteps_str, ...
             'Style','edit', ...
             'Tag','EditText1');
...
%		durtn_str = get(durtn_ctl,'String');
		...
		phaseSequence_str = get(phaseSequence_ctl,'String');
		phaseSteps_str = get(phaseSteps_ctl,'String');
...
%              catch, errordlg('Syntax error in duration'); so=0; end;
		...
		try, phaseSequence = eval(phaseSequence_str);
		catch, phaseSequence = []; end;
		try, phaseSteps = eval(phaseSteps_str);
		catch, phaseSteps = []; end;
...
%                              nCycles = round(durtn .* tFrequency);
			...
			psp = struct('imageType',imageType,'animType',animType,'flickerType',flickerType, ...
			   ...
			   'windowShape',shape,'loops',loops,'phaseSequence',phaseSequence,'phaseSteps',phaseSteps);

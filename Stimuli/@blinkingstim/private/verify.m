...
if proceed,
%	if parameters.fps<=0, proceed = 0; errormsg = 'fps must be positive.'; % fps negative implies seconds
	if parameters.repeat<=0, proceed = 0; errormsg = 'repeat must be positive.';

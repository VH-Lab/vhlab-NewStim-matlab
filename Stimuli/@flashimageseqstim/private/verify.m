...
if proceed, % check that durations and onsets are the same
	if ~eqlen(size(parameters.onsets),size(parameters.durations)),
		proceed = 0;
		errormsg = 'size of parameter ''onsets'' must match size of parameter ''durations''';
	end;
end;

function [img_rgba, destrect, ds_userfields] = make_ps_overlay(PSstim)

% MAKE_PS_overlay - Make a periodicstim to overlay to the primary stim
%
%  [IMAGE, DEST_RECT, DS_USERFIELD] = MAKE_PS_overlay(PSSTIM)
%
%  This function returns the elements necessary for the overlay stim

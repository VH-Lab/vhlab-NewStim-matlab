...
%	durtn_str = '2';
	...
	oldS = struct(oldstim); Hparams = oldS.Hparams;
	rect_str = mat2str(Hparams.rect);
	image_val = (Hparams.imageType+1);
	anim_val = (Hparams.animType+1);
	flicker_val = (Hparams.flickerType+1);
	angle_str = num2str(Hparams.angle);
	chromhigh_str = mat2str(Hparams.chromhigh);
	chromlow_str = mat2str(Hparams.chromlow);
	sFrequency_str = num2str(Hparams.sFrequency);
	tFrequency_str = num2str(Hparams.tFrequency);
	nCycles_str = num2str(Hparams.nCycles);
%	durtn_str = num2str(round(Hparams.nCycles/Hparams.tFrequency));
	...
	smooth_str = num2str(Hparams.nSmoothPixels);
	shape_val = (Hparams.windowShape+1);
	barColor_str = num2str(Hparams.barColor);
	barWidth_str = num2str(Hparams.barWidth);
	sPhase_str = num2str(Hparams.sPhaseShift);
	fixed_str = num2str(Hparams.fixedDur);
	dp_str = wimpcell2str(Hparams.dispprefs);
        if isfield(Hparams,'loops'),
                loops_str = num2str(Hparams.loops);
        else, loops_str = '0';
        end;
end;
